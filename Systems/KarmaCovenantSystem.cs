...
public class KarmaCovenantSystem : ModSystem
{
    ...
    public override void Load()
    {
        ...
        Type helperType =
            thoriumMod.Code.GetType(
                "ThoriumMod.Utilities.ProjectileHelper"
            );

        if (helperType == null)
        {
            Mod.Logger.Warn(
                "未找到 ThoriumMod.Utilities.ProjectileHelper，业果圣约的部分效果不会生效。"
            );
        ...
        {
            Mod.Logger.Warn(
                "未找到 ThoriumHealTarget 方法，业果圣约的部分效果不会生效。"
            );

            return;
        }

        _thoriumHealTargetHook =
            new Hook(
                targetMethod,
                new Func<
                    Func<
        ...
        {
            Mod.Logger.Warn(
                "未找到 Player.HealEffect 方法，业果圣约的共享治疗将不会生效。"
            );
        ...
        object customHealing)
    {
        ...
        CovenantPlayer cp =
            target.GetModPlayer<CovenantPlayer>();
    ...
    private static void OnHealEffect(
        Action<Player, int, bool> orig,
        Player player,
        int healAmount,
        bool broadcast)
    {
