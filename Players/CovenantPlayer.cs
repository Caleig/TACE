    ...
    public class CovenantPlayer : ModPlayer
    {
        ...
        )
        {
            ...
            )
            {
                ...
                if (!eb.EternalHasCovenant)
                    continue;

                if (
                    other.statLife <
                    other.statLifeMax2 * 0.25f
                )
                {
                    continue;
                }
