...
public class AmberCrystalProjectile : ModProjectile
{

    private int reflectionCount;

    private const int MaxReflection = 3;
    ...
    public override string Texture =>
        "ThoriumAccessoryExpansion/Images/Projectiles/MagicContract/AmberCrystalProjectile";
