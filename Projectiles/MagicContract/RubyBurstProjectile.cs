...
public class RubyBurstProjectile : ModProjectile
{
    ...
    {
        shootDirection = Projectile.velocity.SafeNormalize(Vector2.UnitX);
    }
    ...
    private void FireRuby()
    {
        ...
        Projectile.NewProjectile(
            ...
            Projectile.Center,
            shootDirection * 12f,
            ModContent.ProjectileType<RubyCrystalProjectile>(),
            Projectile.damage,
